...
int ctrlSegundero = 100; //Variable control actualizacion del segundero

int contador[] = {0, 9, 1, 0}; // numeros del reloj -> {unidadSegundos, decenaSegundos, unidadMinutos, decenaMinutos}
